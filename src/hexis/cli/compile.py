...
``update_log.json`` and ``report.md``.
    ...
    hexis-agent compile --skill SKILL_DIR --traces TRACE_DIR --out OUT
    hexis-agent compile --skill SKILL_DIR --traces TRACE_DIR --out OUT --machine-init M0.json
"""
...
def main(argv: list[str] | None = None, prog: str | None = None) -> int:
    ...
    if a.machine_init:
        ...
        from hexis.llm.llm_client import ModelAdapter, client_from_env
