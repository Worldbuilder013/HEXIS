...
模型收到的是 :class:`~hexis.compiler.context.CompileContext`：文档正文、条款表、工具定义
...
from hexis.compiler.context import (CompileContext, EventPattern, LabelRule, Requirement, TerminalCondition,
