"""Compare arms on a shared task set: pass rate, cost, paired tests.
    ...
    skill2fsm summarize OUT.md "title" fsm=RUN_DIR skill=RUN_DIR [awm=RUN_DIR rbank=RUN_DIR ...]
...
DISPLAY = {"fsm": "skill2fsm", "skill": "Skill + ReAct", "awm": "AWM", "rbank": "ReasoningBank"}
