...
from skill2fsm import compiler
from skill2fsm.examples import table_clean as tc
from skill2fsm.schema import JudgeAction
...
def test_task_inputs_never_become_branch_predicates():
    ...
    的 s26）。"""
    from skill2fsm.fit import candidate_atoms, learn_cond
    from skill2fsm.schema import Variable
